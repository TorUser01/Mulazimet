...
class Author(User):
    image = models.ImageField(upload_to='media/author', null=True, blank=True, default='favicon.png')
    ...
    education = models.ForeignKey('Education', blank=True, related_name='author_education', on_delete=models.CASCADE,
                                  null=True)
